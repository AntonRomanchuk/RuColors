...
public struct RuColors {
    private let colorsDictionary =
    [
        "Абрикосовый": "FBCEB1",
    ...
    func returnHexCode(colorName: String) -> String? {
        var formattedColorName = colorName.lowercased()
        formattedColorName = formattedColorName.firstCapitalized

        if let hexCode = colorsDictionary[formattedColorName] {
            return hexCode
        } else {
            return nil
        }
